...
part 'salt_state.dart';

class SaltCubit extends Cubit<SaltState> {
  SaltCubit() : super(SaltInitial());
  static SaltCubit get(context) => BlocProvider.of(context);
  void fetchDocuments({required String category}) {
    try {
      ...
      collection
        ...
        emit(SuccessGetSalt(documents));
      });
    } catch (e) {
      emit(FailedGetSalt(e.toString()));
    }
  }
}

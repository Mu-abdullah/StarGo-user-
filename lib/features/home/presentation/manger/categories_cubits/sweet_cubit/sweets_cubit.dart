...
class SweetsCubit extends Cubit<SweetState> {
  SweetsCubit() : super(SweetsInitial());
  static SweetsCubit get(context) => BlocProvider.of(context);
  void fetchDocuments({required String category}) {
    try {
      ...
      collection
        ...
        emit(SuccessGetSweet(documents));
      });
    } catch (e) {
      emit(FailedGetSweet(e.toString()));
    }
  }
}
